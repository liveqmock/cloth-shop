...
<div class="home">
	...
	<!--服装分类-->
	<section class="sort">
		<div @click="search('1','sex','男装')"
		     class="sort-cell">
			<img src="../assets/男装.png" />
			<span>男装</span>
		</div>
		<div @click="search('2','sex','女装')"
		     class="sort-cell">
			<img src="../assets/女装.png" />
			<span>女装</span>
		</div>
		<div @click="search('3','sex','童装')"
		     class="sort-cell">
			<img src="../assets/童装.png" />
			<span>童装</span>
		</div>
		<div @click="search('4','sex','裙装')"
		     class="sort-cell">
	...
	<!--品牌街-->
	<section class="brand">
		<header @click="$router.push({name:'brandStreet'})"
		        class="brand-header">品牌街<i class="iconfont icon-youbian"></i></header>
		<div @click="search(item.id,'brand',item.name)"
		     class="brand-cell"
		     v-for="item in brand">
