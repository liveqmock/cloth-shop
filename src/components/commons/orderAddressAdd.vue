...
<transition mode="out-in"
	...
	<div v-show="show"
		...
		<headerBox :flag="'none'"
		           :title="'添加地址'">
			<div class="back">
				<i @click="$emit('update:show',false)"
		...
		<div class="main-body">
			...
			<div class="place">
				<div @click="showChange"
				     class="place-title">
					<span>所在地区</span>
					<span v-show="!region">请选择<i class="iconfont icon-youbian"></i></span>
					<span v-show="region">{{region?region.sheng.name+region.shi.name+region.qu.name:''}}<i class="iconfont icon-youbian"></i></span>
				</div>
