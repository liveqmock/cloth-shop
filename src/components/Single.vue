		...
		<div class="content-box">
			...
			<div class="first">
				...
				<ul ref="scroll"
					...
					<li @click="flag=index"
					    :key="index"
					    :class="{'first-cell':true,'active-cell':flag==index}"
			...
			<!--二级标题-->
			<div class="second">
				<div @click="search(category[flag].cat_id,category[flag].cat_name)"
				     class="second-header">
				...
				<ul v-if="category.length>0"
				    class="ul">
					<li @click="search(item.cat_id,item.cat_name)"
					    v-for="item in category[flag].child"
					    class="second-cell">
