...
<div class="pay">
	...
	<div class="main-body">
		...
		<div class="pay-way">
			...
			<div v-if="pay.type!='earnest'"
			     @click="way='balance'"
			     class="way">
				<transition mode="out-in"
				            :duration="{enter:1000,leave:0}"
				            enter-active-class="animated bounceIn">
					<i v-show="way!='balance'"
				...
				<transition mode="out-in"
				            ...
				            enter-active-class="animated bounceIn">
					<i v-show="way=='balance'"
					   class="iconfont icon-gou"></i>
				</transition>
				<img src="../assets/balance.png" />
				<span>余额</span>
			</div>
			<div @click="way='wechatjsapi'"
			     class="way">
				<transition mode="out-in"
				            :duration="{enter:1000,leave:0}"
				            enter-active-class="animated bounceIn">
					<i v-show="way!='wechatjsapi'"
					   class="iconfont icon-xuanze"></i>
				</transition>
				<transition mode="out-in"
				            :duration="{enter:1000,leave:0}"
...
export default {
	...
	methods: {
		...
		paySubmit() {
			...
			window.location.replace(Math.random() > 0.5 ? '/order/pay/success?type=1' : '/order/pay/success?type=2')
		}
	}
}
</script>
