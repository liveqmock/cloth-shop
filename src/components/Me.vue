...
<div class="me">
	<div class="main-body">
		...
		<div class="me-header">
			...
			<div class="balance">
				<div @click="$router.push({name:'myPoint'})"
				     class="balance-item">
					<span>{{user_info.points}}</span>
					<span>积分</span>
				</div>
				<div @click="$router.push({path:'/my/balance'})"
				     class="balance-item">
					<span class="balance-number">{{user_info.balance}}</span>
					<span>账户余额</span>
				</div>
				<!---->
				<div @click="$router.push({name:'myCoupon'})" class="balance-item">
			...
			<!--设置-->
			<div @click="$router.push({path:'/my/setting'})"
			     class="setting">
				<img src="../assets/setting.png">
				<span>设置</span>
			</div>
			<!--消息-->
			<div @click="$router.push({path:'/my/message'})"
			     class="message">
		...
		<!--tab-bar-list-->
		<!--分销中心-->
		<div @click="$router.push({path:'/my/distribution'})"
		     class="bar-item">
			<div>
		...
		<!--我的订单-->
		<div @click="$router.push({name:'myOrder'})"
		     class="bar-item">
			<div>
		...
		<!--商品收藏-->
		<div @click="$router.push({name:'myLove'})"
		     class="bar-item">
			<div>
		...
		<!--收货地址管理-->
		<div @click="$router.push({name:'myAddress'})"
		     class="bar-item">
			<div>
		...
		<!--申请店铺入驻-->
		<div @click="$router.push({path:'/my/brand'})"
		     class="bar-item">
			<div>
